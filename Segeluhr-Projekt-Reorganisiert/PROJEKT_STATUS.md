...
- **12.08.: grosse Nachtrags-Runde komplett ungetestet** — sehr viele
  Änderungen an einem Tag (siehe Android-App-/Ultra-/S3-Zeilen oben), alle
  nur kompiliert. Konsolidierte Checkliste für den nächsten Testtag:
  `docs/Test_Checkliste_12_08.md` (Teilmenge davon schon an Land ohne
  Segeln testbar).
