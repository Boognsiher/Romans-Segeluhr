...
- ~~**`distanceTraveledM`-Aufsummierung in der App**~~ — 10.08. implementiert
  ...
  Detail-Screen-Paket-Info-Zeile. **Betrifft alle drei Komponenten
  (Android-App + beide Firmwares) — müssen zusammen neu gebaut/geflasht
  werden**, siehe `docs/BLE_Protokoll_Ergaenzung_Heimweg_LoRa.md`. **Noch
  nicht kompiliert/getestet.**
...
- ~~**Boots-Kalibrierung: aktuell nur ein globales Profil, Roman will
  ...
  `docs/Erweiterung_Boots_Kalibrierung.md`. **Noch nicht kompiliert/getestet.**
